...
export default function MoodSearch() {
  return (
    <div className="font-main bg-mood h-screen flex flex-col justify-between">
      <div>
        <Link to="/">
          <img
            src={logo}
        ...
        <div className="grid place-items-center mt-16 md:mt-24 lg:mt-32">
          <p className="text-center font-extrabold text-3xl mx-2 md:text-5xl lg:text-6xl">
          ...
          <div className="flex justify-between md:gap-16 mt-8 md:mt-12 lg:mt-16">
            <img src={lyrics} className="w-5/6 lg:w-full" alt="lyrics" />
          </div>
